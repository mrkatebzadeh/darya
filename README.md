...
![darya](https://github.com/user-attachments/assets/548e252f-76e7-4ea5-acf6-e1ca764bbe37)

## Installation
1. Visit the [darya releases page](https://github.com/mrkatebzadeh/darya/releases) and download the latest archive for your platform.
2. Extract the archive and place the `darya` binary somewhere on your `PATH` (for example, `/usr/local/bin`).
